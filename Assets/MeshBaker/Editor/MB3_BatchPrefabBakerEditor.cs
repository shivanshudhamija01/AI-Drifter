...
namespace DigitalOpus.MB.MBEditor
{
    ...
    public class MB3_BatchPrefabBakerEditor : Editor
    {
        ...
        private int prefabRows_CurrentPage = 1;
        private int prefabRows_NumPerPage = 50;
        ...
        public override void OnInspectorGUI()
        {
            ...
            MB_PaginatedList.GenerateObjectsToBeCombinedList(prefabRows, ref prefabRows_CurrentPage, ref prefabRows_NumPerPage);

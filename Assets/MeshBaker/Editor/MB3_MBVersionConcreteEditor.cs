...
namespace DigitalOpus.MB.Core
{
    ...
    public class MBVersionEditorConcrete : MBVersionEditorInterface
    {
        ...
        public string GetScriptingDefineSymbolsFromTg(BuildTargetGroup tg)
        {
#if UNITY_2021_2_OR_NEWER
            NamedBuildTarget namedBuildTarget = NamedBuildTarget.FromBuildTargetGroup(tg);
            return PlayerSettings.GetScriptingDefineSymbols(namedBuildTarget);
#else
            return PlayerSettings.GetScriptingDefineSymbolsForGroup(tg);
#endif
        }
        ...
        public bool GenerateSecondaryUVSetForUnwrapping(Mesh src, UnwrapParam settings)
        {
#if UNITY_2022_1_OR_NEWER
            bool unwrappingSuccessful = Unwrapping.GenerateSecondaryUVSet(src, settings);
            return unwrappingSuccessful;
#else
